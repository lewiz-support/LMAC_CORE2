...
tie %Config, 'Config', {
    ...
    archlibexp => '/usr/lib/perl/5.24.1/',
    archname => 'aarch64-linux',
    cc => 'aarch64-poky-linux-gcc  ',
    cccdlflags => '-fPIC',
    ccdlflags => '-Wl,-E -Wl,-rpath,/usr/lib/perl/5.24.1//CORE',
    d_flexfnam => 'define',
    d_link => 'define',
    d_readlink => 'define',
    d_symlink => 'define',
    ...
    installman1dir => '',
    installman3dir => '',
    installprivlib => '/usr/lib/perl/5.24.1',
    installscript => '/usr/bin',
    installsitearch => '/usr/lib/perl/site_perl/5.24.1/',
    ...
    path_sep => ':',
    privlibexp => '/usr/lib/perl/5.24.1',
    ranlib => ':',
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/lib/perl/site_perl/5.24.1/',
    sitelibexp => '/usr/lib/perl/site_perl/5.24.1',
    so => 'so',
    useithreads => 'define',
    usevendorprefix => 'define',
    vendorarchexp => '/usr/lib/perl/vendor_perl/5.24.1/',
    vendorlibexp => '/usr/lib/perl/vendor_perl/5.24.1',
    version => '5.24.1',
};
