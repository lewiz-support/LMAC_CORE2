...
source C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/5G_TEST_CASES/5G_PERFORMANCE_TEST_7/script_5G.txt


Expected results:
---------------------------------------------------------------
The length of pkt_1 = 64 bytes 
The number of valid bytes in the last quardword = 8 
The number of bytes in gap = 11 
---------------------------------------------------------------
The length of pkt_2 = 1281 bytes 
