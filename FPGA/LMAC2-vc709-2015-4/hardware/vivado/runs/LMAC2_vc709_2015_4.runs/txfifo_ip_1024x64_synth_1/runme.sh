...
HD_PWD='C:/SUNNY2/LMAC2-vc709-2015-4/hardware/vivado/runs/LMAC2_vc709_2015_4.runs/txfifo_ip_1024x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log txfifo_ip_1024x64.vds -m64 -mode batch -messageDb vivado.pb -notrace -source txfifo_ip_1024x64.tcl
