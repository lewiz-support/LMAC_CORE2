...
HD_PWD='C:/SUNNY2/LMAC2-vc709-2015-4/hardware/vivado/runs/LMAC2_vc709_2015_4.runs/ipcs_fifo_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ipcs_fifo_ip.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ipcs_fifo_ip.tcl
