...
HD_PWD='C:/SUNNY2/LMAC2-vc709-2015-4/hardware/vivado/runs/LMAC2_vc709_2015_4.runs/gigerx_fifo_ip_256x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gigerx_fifo_ip_256x64.vds -m64 -mode batch -messageDb vivado.pb -notrace -source gigerx_fifo_ip_256x64.tcl
