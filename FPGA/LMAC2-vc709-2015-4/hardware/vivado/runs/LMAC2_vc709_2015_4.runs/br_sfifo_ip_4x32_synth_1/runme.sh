...
HD_PWD='C:/SUNNY2/LMAC2-vc709-2015-4/hardware/vivado/runs/LMAC2_vc709_2015_4.runs/br_sfifo_ip_4x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log br_sfifo_ip_4x32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source br_sfifo_ip_4x32.tcl
