...
#
# Generated by export_simulation on Thu Jan 19 09:26:38 -0800 2017
#
################################################################################
...
switch to the './pktctrl_fifo_ip.sh' script.

./pktctrl_fifo_ip.sh -reset_run
...
./pktctrl_fifo_ip.sh -noclean_files

For more information on the script, please type './pktctrl_fifo_ip.sh -help'.
