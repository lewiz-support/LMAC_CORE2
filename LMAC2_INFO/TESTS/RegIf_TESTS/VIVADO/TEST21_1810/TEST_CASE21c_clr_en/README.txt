...
We have 1 packet with number of bytes in range 128 to 255, so, the FMAC_RX_PKT_CNT255_LO register gets updated with the value 1
Clear signal is provided from the axi_master by asserting the 7th bit of the fmac_ctrl signal from the axi_master
Once the clear signal is provided, the FMAC_RX_PKT_CNT255_LO changes its value to 0 and accordingly the mac_regdout signal in the axi_master
