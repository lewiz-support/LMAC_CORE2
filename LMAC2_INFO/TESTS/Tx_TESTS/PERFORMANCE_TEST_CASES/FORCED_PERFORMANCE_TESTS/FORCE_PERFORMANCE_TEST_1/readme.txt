...
1.Run the following script
  source C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/FORCED_PERFORMANCE_TESTS/FORCE_PERFORMANCE_TEST_1/script_1G.txt

***For 2.5G transmission mode:
   Run the following script
   source C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/FORCED_PERFORMANCE_TESTS/FORCE_PERFORMANCE_TEST_1/script_2p5G.txt

***For 5G transmission mode:
   Run the following script
   source C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/FORCED_PERFORMANCE_TESTS/FORCE_PERFORMANCE_TEST_1/script_5G.txt

***For 10G transmission mode:
   Run the following script
   source C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/FORCED_PERFORMANCE_TESTS/FORCE_PERFORMANCE_TEST_1/script_10G.txt
