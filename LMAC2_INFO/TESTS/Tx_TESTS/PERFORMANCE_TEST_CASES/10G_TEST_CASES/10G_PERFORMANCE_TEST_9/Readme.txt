...
source C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/10G_TEST_CASES/10G_PERFORMANCE_TEST_9/script_10G.txt


Expected results:
---------------------------------------------------------------
The length of pkt_1 = 40 bytes 
The number of valid bytes in the last quardword = 8 
The number of bytes in gap = 11 
---------------------------------------------------------------
The length of pkt_2 = 61 bytes 
