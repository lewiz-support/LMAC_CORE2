...
$readmemh("C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/10G_TEST_CASES/10G_PERFORMANCE_TEST_5/10G_performance_test5_ctrl.txt",memory_wr_ctrl);
$readmemh("C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/10G_TEST_CASES/10G_PERFORMANCE_TEST_5/10G_performance_test5_data.txt",memory_wr_data);

2.Run the following script
source C:/LMAC2_INFO/TESTS/Tx_TESTS/PERFORMANCE_TEST_CASES/10G_TEST_CASES/10G_PERFORMANCE_TEST_5/Script_10G_performance.txt
...
---------------------------------------------------------------
The length of pkt_5 = 1238 bytes 
The number of valid bytes in the last quardword = 6 
---------------------------------------------------------------
The length of pkt_6 = 320 bytes 
The number of valid bytes in the last quardword = 8 
---------------------------------------------------------------
The length of pkt_7 = 1383 bytes 
The number of valid bytes in the last quardword = 7 
---------------------------------------------------------------
The length of pkt_8 = 346 bytes 
